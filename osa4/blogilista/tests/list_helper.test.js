...
describe("total likes", () => {
  test("amount of likes in an empty list is 0", () => {
    const result = listHelper.totalLikes(emptyList);
    expect(result).toBe(0);
  });

  test("amount of likes in a list of one blog is calculated", () => {
    const result = listHelper.totalLikes(listWithOneBlog);
    expect(result).toBe(5);
  });

  test("amount of likes in a long list of blogs is calculated", () => {
